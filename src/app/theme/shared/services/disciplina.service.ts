...
export class DisciplinaService {
    ...
    findById(id: number): Observable<DisciplinaDTO> {
      ...
      getByPageDisciplinaFromIgreja(igrejaId: number, nome: string, page: number, linesPerPage: number) {
      ...
      getByPageDisciplinaFromTipo(igrejaId: any, nome: any, page: any, linesPerPage: any) {
      ...
      getListDisciplinaFromIgreja(igrejaId: number) {
